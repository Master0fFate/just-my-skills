...
description: Convert the user's initial request into a fully-specified, unambiguous, execution-ready prompt through structured interaction. (by github.com/Master0fFate)
version: 1.0
user-invocable: true
