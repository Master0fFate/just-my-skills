...
const IMPECCABLE_HOOK_COMMAND_MARKERS = [
  'skills/sexyness/toolkits/impeccable/scripts/hook-probe.mjs',
  'skills/sexyness/toolkits/impeccable/scripts/hook.mjs',
  'skills/sexyness/toolkits/impeccable/scripts/hook-before-edit.mjs',
  'skills/sexyness/toolkits/impeccable/scripts/hook-after-edit.mjs',
  'skills/sexyness/toolkits/impeccable/scripts/hook-stop.mjs',
];
...
const HOOK_MANIFEST_TARGETS = [
  {
    provider: '.claude',
    skillRel: '.claude/skills/sexyness/toolkits/impeccable',
    ...
    manifest: () => ({
      ...
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node "${CLAUDE_PROJECT_DIR}/.claude/skills/sexyness/toolkits/impeccable/scripts/hook.mjs"',
        ...
        Stop: [stopManifestEntry('node "${CLAUDE_PROJECT_DIR}/.claude/skills/sexyness/toolkits/impeccable/scripts/hook.mjs"')],
      },
    }),
  },
  {
    provider: '.agents',
    skillRel: '.agents/skills/sexyness/toolkits/impeccable',
    ...
    manifest: () => ({
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node ".agents/skills/sexyness/toolkits/impeccable/scripts/hook.mjs"',
                timeout: TIMEOUT_SECONDS,
                statusMessage: STATUS_MESSAGE,
              },
            ],
        ...
        Stop: [stopManifestEntry('node ".agents/skills/sexyness/toolkits/impeccable/scripts/hook.mjs"')],
      },
    }),
  },
  {
    provider: '.cursor',
    skillRel: '.cursor/skills/sexyness/toolkits/impeccable',
    ...
    manifest: () => ({
      ...
      hooks: {
        preToolUse: [
          {
            command: 'node ".cursor/skills/sexyness/toolkits/impeccable/scripts/hook-before-edit.mjs"',
            timeout: TIMEOUT_SECONDS,
          },
        ],
      },
  ...
  },
  {
    ...
    provider: '.github',
    skillRel: '.github/skills/sexyness/toolkits/impeccable',
        ...
        postToolUse: [
          {
            ...
            bash: 'node "$(git rev-parse --show-toplevel)/.github/skills/sexyness/toolkits/impeccable/scripts/hook.mjs"',
