...
/**
 * Read the installed skill's own version from the sibling TOOLKIT.md frontmatter
...
function readLocalSkillVersion() {
  try {
    ...
    const skillMd = path.join(here, '..', 'TOOLKIT.md');
...
function valueHasHookMarker(value) {
  if (typeof value === 'string') {
    return value.includes('skills/sexyness/toolkits/impeccable/scripts/hook.mjs')
      || value.includes('skills/sexyness/toolkits/impeccable/scripts/hook-before-edit.mjs');
  }
