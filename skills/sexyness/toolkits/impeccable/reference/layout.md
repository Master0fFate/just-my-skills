...
```bash
node .agents/skills/sexyness/toolkits/impeccable/scripts/detect.mjs --json --scope layout [target files or dirs]
```
...
When the structure holds, hand off to `$sexyness toolkit polish`.
