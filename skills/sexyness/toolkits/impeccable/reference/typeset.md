...
```bash
node .agents/skills/sexyness/toolkits/impeccable/scripts/detect.mjs --json --scope type [target files or dirs]
```
...
When the hierarchy holds, hand off to `$sexyness toolkit polish`.
